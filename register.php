            ...
            <div class="auth-box ">
                <div class="left">
                    <div class="content">
                        ...
                        <?php
                        if(isset($_SESSION['u_reg_error'])  && $_GET['u_reg_error'] == 'Y'){
                            ?>
                            <p class="alert-danger"> <?php echo $_SESSION['u_reg_error'];?></p>
                        <?php
                        }
                        ?>
                        ...
                        <form class="form-auth-small" action="process.php" method="post">
                            ...
                            <div class="form-group">
                                <label for="signup-full_name" class="control-label sr-only">Full Name</label>
                                <input type="text" class="form-control" id="signup-full_name" placeholder="Enter Full Name...." name="full_name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="bottom">
                                <span><a href="login.php">Already A member? Login Now!</a></span><br>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="right">
                    ...
                    <div class="content text">
                        <h1 class="heading">Sign up for free to experience your dream job! </h1>
                        <p>by Job Portal</p>
                    </div>
                </div>
