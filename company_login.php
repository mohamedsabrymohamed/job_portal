            ...
            <div class="auth-box ">
                <div class="left">
                    <div class="content">
                        ...
                        <?php
                        if(isset($_SESSION['company_reg_succ']) && $_GET['company_reg_succ'] == 'Y'){
                            ?>
                            <p class="alert-success"> <?php echo $_SESSION['company_reg_succ'];?></p>
                            <?php
                        }elseif (isset($_SESSION['err_compname_pass']) && $_GET['err_compname_pass'] == 'Y'){
                        ?>
                            <p class="alert-danger"> <?php echo $_SESSION['err_compname_pass'];?></p>
                            <?php
                        }?>
                        <form class="form-auth-small" action="process.php" method="post">
                            <input type="hidden" name="form_name" value="company_login">
                            ...
                            <div class="bottom">
                                <span><a href="company_registration.php">Not A Company? SignUp Now!</a></span><br>
                            </div>
                        </form>
                    </div>
                </div>
