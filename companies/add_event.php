    ...
    <form method="post" action="../process.php">
        ...
        <div class="col-md-12 latest-job ">
            <div class="form-group">
                <input class="form-control input-sm" type="text"  name="event_title" placeholder="Event Title" required>
            </div>


                <div class="form-group">
                    <input class="form-control input-sm" type="date"  name="event_date" placeholder="Event Date" required>
                </div>
            ...
            <div class="form-group">
                <textarea class="form-control input-sm" id="description" name="event_desc" rows="6" placeholder="Job Description"></textarea>
            </div>
